    ...
    public function run()
    {
        DB::table('pages')->insert([
            ...
            [
                'name' => 'about',
                'author_id' => 1,
                'content' => '<p><img alt="" class="alignnone size-full wp-image-1710" src="https://s3.us-east-2.amazonaws.com/hugoenglishclub/page/about.jpg" style="width:675px" /></p>
            ...
            [
                'name' => 'contact',
                'author_id' => 1,
                'content' => '<p><img alt="" class="alignnone size-full wp-image-1713" src="https://s3.us-east-2.amazonaws.com/hugoenglishclub/page/contact.jpg" style="width:675px" /></p>
