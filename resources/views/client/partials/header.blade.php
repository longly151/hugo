<header id="header" class="header-header-2" itemscope="itemscope" itemtype="http://schema.org/WPHeader">
    ...
    <nav id="navigation" class="header-layout-bottom menu-style-1 header-2 menu-item-padding" role="navigation"
        ...
        <div class="container">
            ...
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-119"><a href="{{url('/gallery')}}">Gallery</a></li>
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-119"><a href="{{url('/contact')}}">Contact</a></li>
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-119"><a href="{{url('/about')}}">About</a></li>
            </ul>
