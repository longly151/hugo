<div id="sidebar" class="penci-sidebar-content style-5 pcalign-left penci-sticky-sidebar col-lg-4 col-md-12">
				<div class="theiaStickySidebar">
					...
					{{-- <aside id="mc4wp_form_widget-2" class="widget widget_mc4wp_form_widget">
						...
						<form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-1697" method="post" data-id="1697" data-name="Form">
							<div class="mc4wp-form-fields">
								...
								<div style="display: none;"><input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></div><input
								 type="hidden" name="_mc4wp_timestamp" value="1546967825" /><input type="hidden" name="_mc4wp_form_id" value="1697" /><input
					...
					{{-- <aside id="categories-2" class="widget widget_categories">
						...
						<ul>
							...
							<li class="cat-item cat-item-9"><a href="category/coffee-update/coffee-tips/index.html">Coffee Tips <span class="category-item-count">(7)</span></a>
							</li>
							<li class="cat-item cat-item-6"><a href="category/featured/index.html">Featured <span class="category-item-count">(6)</span></a>
							</li>
