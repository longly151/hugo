<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="32x32" href="/public/client/images/favicon2.png">
  ...
  @include('client.partials.stylesheets')
  ...
  <script type='text/javascript' src='/public/client/js/jquery.js'></script>
  <script type='text/javascript' src='/public/client/js/jquery-migrate.min.js'></script>
  <script type="application/ld+json">
    {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "http:\/\/soledad.pencidesign.com\/soledad-coffee-blog\/wp-content\/themes\/soledad\/images\/logo.png"
      },
  ...
  <script type="application/ld+json">
    {
      ...
      "potentialAction": {
        "@type": "SearchAction",
        "target": "http:\/\/soledad.pencidesign.com\/soledad-coffee-blog\/search\/{search_term}",
