                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/category/edit/topcate/').'/'.$topCategory['id'] }}" class="btn btn-primary btn-xs">
                                            <i class="fa fa-folder"></i> Edit </a>
                                        <button data-id="{{ $topCategory['id'] }}" type="button" class="btn btn-danger btn-xs deleteTopCategory">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        session()->get('admin')['id']||session()->get('admin')['role']=='admin'||session()->get('admin')['role']=='moderator')
                                        <a href="{{ url('admin/category/edit/cate').'/'.$category['id'] }}" class="btn btn-primary btn-xs">
                                            <i class="fa fa-folder"></i> Edit </a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        session()->get('admin')['id']||session()->get('admin')['role']=='admin'||session()->get('admin')['role']=='moderator')
                                        <a href="{{ url('admin/category/edit/subcate').'/'.$subCategory['id'] }}" class="btn btn-primary btn-xs">
                                            <i class="fa fa-folder"></i> Edit </a>
                                        <button data-id="{{ $subCategory['id'] }}" type="button" class="btn btn-danger btn-xs deleteSubCategory">
                                            <i class="far fa-trash-alt"></i> Delete </button>
                                        @endif
                                    </td>
                                </tr>
...
<script>
    $(function () {
        ...
        var $searchableTree = $('#treeview-searchable').treeview({
            ...
            // }
            // <a style="z-index:1000;"href="{{ url('admin/category/edit').'/'.${topCategory["id"]}" class="btn btn-primary btn-xs">
            //         <i class="fa fa-folder"></i> Edit </a>
