        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">Page List</h6>
                    @if(session('success'))
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/{{$page->url}}" class="btn btn-success btn-xs" target="_blank">
                                            <i class="fa fa-folder"></i> View </a>
                                        <a href="/admin/page/edit/{{$page->id}}" class="btn btn-primary btn-xs">
